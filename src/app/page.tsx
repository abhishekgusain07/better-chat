      ...
      <div className="max-w-2xl w-full text-center space-y-8">
        ...
        <div className="space-y-6">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-md mx-auto">
            A clean, simple, and elegant starting point for your Next.js project.
          </p>
        </div>
        ...
        <div className="pt-16 grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          <div className="space-y-3">
            ...
            <p className="text-gray-600 text-sm">Clean interface with minimal distractions for better focus.</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-gray-600 text-sm">Intuitive navigation and clear calls to action.</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-gray-600 text-sm">Built with Next.js and the latest web technologies.</p>
          </div>
        </div>
        
        {/* Footer */}
        <div className="pt-16 text-sm text-gray-500">
          <p>© {new Date().getFullYear()} Minimalist Template. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
