...
import { BenefitGrantError, BenefitGrantError$Outbound } from "./benefitgranterror.js";
...
export type BenefitGrantWebhookProperties = BenefitGrantDiscordProperties | BenefitGrantGitHubRepositoryProperties | BenefitGrantDownloadablesProperties | BenefitGrantLicenseKeysProperties | BenefitGrantCustomProperties;
export type PreviousProperties = BenefitGrantDiscordProperties | BenefitGrantGitHubRepositoryProperties | BenefitGrantDownloadablesProperties | BenefitGrantLicenseKeysProperties | BenefitGrantCustomProperties;
export type BenefitGrantWebhook = {
    ...
    benefit: Benefit;
    previousProperties?: BenefitGrantDiscordProperties | BenefitGrantGitHubRepositoryProperties | BenefitGrantDownloadablesProperties | BenefitGrantLicenseKeysProperties | BenefitGrantCustomProperties | null | undefined;
};
/** @internal */
...
/** @internal */
export type BenefitGrantWebhookProperties$Outbound = BenefitGrantDiscordProperties$Outbound | BenefitGrantGitHubRepositoryProperties$Outbound | BenefitGrantDownloadablesProperties$Outbound | BenefitGrantLicenseKeysProperties$Outbound | BenefitGrantCustomProperties$Outbound;
/** @internal */
...
/** @internal */
export type PreviousProperties$Outbound = BenefitGrantDiscordProperties$Outbound | BenefitGrantGitHubRepositoryProperties$Outbound | BenefitGrantDownloadablesProperties$Outbound | BenefitGrantLicenseKeysProperties$Outbound | BenefitGrantCustomProperties$Outbound;
/** @internal */
...
export type BenefitGrantWebhook$Outbound = {
    ...
    properties: BenefitGrantDiscordProperties$Outbound | BenefitGrantGitHubRepositoryProperties$Outbound | BenefitGrantDownloadablesProperties$Outbound | BenefitGrantLicenseKeysProperties$Outbound | BenefitGrantCustomProperties$Outbound;
    benefit: Benefit$Outbound;
    previous_properties?: BenefitGrantDiscordProperties$Outbound | BenefitGrantGitHubRepositoryProperties$Outbound | BenefitGrantDownloadablesProperties$Outbound | BenefitGrantLicenseKeysProperties$Outbound | BenefitGrantCustomProperties$Outbound | null | undefined;
};
/** @internal */
