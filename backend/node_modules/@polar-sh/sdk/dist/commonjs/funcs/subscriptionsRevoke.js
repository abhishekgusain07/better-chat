...
const subscription_js_1 = require("../models/components/subscription.js");
...
async function $do(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => subscriptionsrevoke_js_1.SubscriptionsRevokeRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
