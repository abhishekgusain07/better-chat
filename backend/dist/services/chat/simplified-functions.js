...
exports.serviceLayerHealthCheck = exports.simplifiedChatFunctions = void 0
const logger_1 = require('@/utils/logger')
exports.simplifiedChatFunctions = {
  ...
  processMessage(context, messageData, conversationData) {
    logger_1.logger.info('Processing message via service layer', {
  ...
  optimizeContext(messages, maxTokens) {
    ...
    logger_1.logger.info('Context optimization completed', {
...
exports.serviceLayerHealthCheck = {
  async checkHealth() {
    try {
      return {
        healthy: true,
      ...
      logger_1.logger.error('Service health check failed:', error)
      return {
        healthy: false,
        services: [],
      }
...
//# sourceMappingURL=simplified-functions.js.map
